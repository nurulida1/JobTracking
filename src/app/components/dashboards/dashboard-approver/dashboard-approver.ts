...
@Component({
  ...
  imports: [CommonModule, ChartModule, RouterLink, ButtonModule],
  template: `<div class="w-full pt-10 pb-20 md:p-2">
      ...
      >
        ...
        <div class="flex space-x-8 p-4">
          ...
          <div class="text-center flex-1">
            <div class="text-4xl font-semibold tracking-widest text-yellow-400">
        ...
        <div class="flex justify-center px-4 pb-4 gap-3">
          <p-button
            *ngIf="role === 'Planner'"
            ...
            styleClass="!px-5 !py-2 !text-gray-700 !text-sm !tracking-wider !border-[#40A0AC] !border-2 !rounded-md !font-semibold !transition duration-200 hover:!bg-cyan-200 !bg-white"
            label="Create New Quote"
          ></p-button>
          <p-button
            styleClass="!px-5 !py-2 !border-2 !border-gray-200 !text-sm !tracking-wider !bg-gray-200 hover:!bg-gray-300 !rounded-md !transition duration-200 !text-gray-600"
            label="View Reports"
          ></p-button>
        </div>
      </div>
      ...
      >
        ...
        <div class="flex justify-between p-4">
          <div>
            ...
            <div class="text-sm text-gray-400">Personnel Working (RM)</div>
          </div>
          <div>
            <div class="text-2xl font-semibold tracking-widest text-gray-700">
              0.00
            </div>
            <div class="text-sm text-gray-400">Total Material Cost (RM)</div>
          </div>
        </div>
...
export class DashboardApprover implements OnInit, OnDestroy {
